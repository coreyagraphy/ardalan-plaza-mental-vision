...
function AmbientLife({ mats }: { mats: PlazaMats }) {
  ...
  return (
    <group name="AMBIENT_LIFE">
      <CafeTable x={14.2} z={z} mats={mats} umbrella />
      <CafeTable x={17.6} z={z + 0.45} mats={mats} umbrella />
      <CafeTable x={21.4} z={z} mats={mats} umbrella />
      <CafeTable x={25.2} z={z + 0.2} mats={mats} umbrella />
      <CafeTable x={29.0} z={z} mats={mats} umbrella />

      <Person x={14.05} z={z + 0.55} look={A} rot={0.4} pose="sit" />
      <Person x={14.55} z={z + 0.5} look={B} rot={-0.5} pose="sit" />
      <Person x={17.4} z={z + 0.95} look={C} rot={2.6} pose="sit" />
      <Person x={21.2} z={z + 0.55} look={E} rot={0.2} pose="sit" />
      <Person x={25.0} z={z + 0.5} look={F} rot={-0.3} pose="sit" />

      <Person x={16.4} z={z + 1.8} look={D} rot={0.8} />
      <Person x={17.0} z={z + 2.05} look={B} rot={-2.2} />
      <Person x={22.8} z={z + 1.35} look={E} rot={-1.2} />
      <Person x={23.2} z={z + 1.55} look={H} rot={2.1} />
      <Person x={32.6} z={z + 1.9} look={C} rot={-0.6} />

      <Person x={-3.4} z={4.8} look={B} rot={-0.9} />
      <Person x={-2.6} z={5.15} look={A} rot={2.4} />
      <Person x={-1.8} z={-12.4} look={F} rot={0.4} />
      <Person x={-1.4} z={-18.6} look={G} rot={1.2} />

      <Walker x0={12} z0={z + 1.6} x1={32} z1={z + 2.1} look={A} speed={0.09} phase={0.12} />
      <Walker x0={34} z0={z + 2.4} x1={14} z1={z + 1.9} look={C} speed={0.08} phase={0.55} />
      <Walker x0={20} z0={z + 1.85} x1={28} z1={z + 2.2} look={G} speed={0.095} phase={0.02} />
      <Walker x0={-1.6} z0={-12} x1={-1.8} z1={-28} look={D} speed={0.1} phase={0.3} />
      <Walker x0={-1.9} z0={-26} x1={-1.5} z1={-10} look={E} speed={0.07} phase={0.18} />
      <Walker x0={18} z0={z + 2.0} x1={8} z1={z + 2.5} look={B} speed={0.088} phase={0.41} />
      <Walker x0={26} z0={z + 2.8} x1={16} z1={z + 1.7} look={H} speed={0.078} phase={0.88} />
    </group>
  );
}
